...
const seedUsersPassword = process.env.SEED_USERS_PASSWORD;

if (!seedUsersPassword) {
  throw new Error(
    "SEED_USERS_PASSWORD is not set. Add it to your .env before running the seed.",
  );
}
  ...
  users: [
    {
      ...
      password: bcryptjs.hashSync(seedUsersPassword, 10),
      role: "admin",
    },
    {
